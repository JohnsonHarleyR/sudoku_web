...
public class UnsolvedBoard {
	...
	@ManyToOne
	private CompleteBoard completeId;
	...
	@Transient
	String[] groupNames = {"A1", "A2", "A3", "B1", "B2", "B3", "C1", "C2", "C3"};
	...
	public void setCompleteId(CompleteBoard completeId) {
	...
	public CompleteBoard getCompleteId() {
		return completeId;
	}

	public void setComplete(CompleteBoard completeId) {
		this.completeId = completeId;
	}
	...
	public String toString() {
		return "UnsolvedBoard [id=" + id + ", a1=" + a1 + ", a2=" + a2 + ", a3=" + a3 + ", a4=" + a4 + ", a5=" + a5
				...
				+ ", i4=" + i4 + ", i5=" + i5 + ", i6=" + i6 + ", i7=" + i7 + ", i8=" + i8 + ", i9=" + i9
				+ ", completeId=" + completeId + ", cellMap=" + cellMap + ", groupMap=" + groupMap + ", rowA="
				+ Arrays.toString(rowA) + ", rowB=" + Arrays.toString(rowB) + ", rowC=" + Arrays.toString(rowC)
				+ ", rowD=" + Arrays.toString(rowD) + ", rowE=" + Arrays.toString(rowE) + ", rowF="
				+ Arrays.toString(rowF) + ", rowG=" + Arrays.toString(rowG) + ", rowH=" + Arrays.toString(rowH)
				+ ", rowI=" + Arrays.toString(rowI) + ", col1=" + Arrays.toString(col1) + ", col2="
				+ Arrays.toString(col2) + ", col3=" + Arrays.toString(col3) + ", col4=" + Arrays.toString(col4)
				+ ", col5=" + Arrays.toString(col5) + ", col6=" + Arrays.toString(col6) + ", col7="
				+ Arrays.toString(col7) + ", col8=" + Arrays.toString(col8) + ", col9=" + Arrays.toString(col9) + "]";
	}
